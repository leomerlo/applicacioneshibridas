...
const Button = (props: PropsWithChildren<ButtonProps>) => {
  ...
  return (
    <button type={props.type} disabled={props.loading || props.disabled} className={ `${props.className || ''} rounded focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 focus:text-black ${props.full ? 'w-full' : '' } ${variantClasses()} flex items-center` } onClick={props.onClick}>
